        ...
        <tbody>
          {dashBoard.map((dashData, index) => (
            <tr key={dashData._id}>
              ...
              <td>
                <a href={'http://localhost:3001/'+dashData.shortid}>{'http://localhost:3001/'+dashData.shortid}</a>
                <a href={'http://localhost:3001/'+dashData.shortid} target="_blank" style={redirectionLinkIcon} rel="noopener noreferrer">
